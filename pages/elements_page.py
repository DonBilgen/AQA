...
from locators.elements_page_locators import TextBoxPageLocators, CheckBoxPageLocators, CheckRadioButtonPageLocators, \
    ...
    def click_random_checkbox(self):
        ...
        while count != 0:
            ...
            if count > 0:
                ...
                item.click()
                # print(str(count) +"_afterclick: "+item.text)
                count -= 1
            else:
                break
...
class RadioButtonPage(BasePage):
    locators = CheckRadioButtonPageLocators()

    def click_radio_button(self, choice):
        choices = {'yes': self.locators.YES_RADIOBTN,
                   'impressive': self.locators.IMPRESSIVE_RADIOBTN,
                   'no': self.locators.NO_RADIOBTN}

        radio = self.element_is_visible(choices[choice]).click()

    def get_output_result(self):
        return self.element_is_present(self.locators.OUTPUT_RADIOBTN).text
...
class WebTablePage(BasePage):
    ...
    def select_up_to_some_rows(self):
        ...
        for x in count:
            print('')
            print(x)
            self.go_to_element(self.locators.COUNT_ROW_LIST).click()
...
class UploadAndDownloadPage(BasePage):
    ...
    def upload_file(self):
        ...
        time.sleep(5)
        os.remove(path)
        text = self.element_is_present(self.locators.UPLOADED_FILE_NAME).text
    ...
    def download_file(self):
        ...
        link_b64 = base64.b64decode(link)
        path_name_file = rf'C:\Users\Bil\Documents\GitHub\AQA\filetest{random.randint(0,999)}.jpg'
        with open(path_name_file, 'wb+') as f:
            offset = link_b64.find(b'\xff\xd8')
            f.write(link_b64[offset:])
